...
from common.veriables import ACTION, MESSAGE, SENDER, MESSAGE_TEXT, TIME, ACCOUNT_NAME, PRESENCE, USER, RESPONSE, ERROR, \
...
def create_message(sock, account_name='Guest'):
    # Функция запрашивает текст сообщения и возвращает
    # его. Так же завершает работу при вводе подобной комманды
