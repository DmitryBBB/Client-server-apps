...
from common.veriables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, RESPONSE_200, RESPONSE_400, ERROR, MESSAGE, \
    DESTINATION, SENDER, MESSAGE_TEXT, EXIT, DEFAULT_PORT, MAX_CONNECTIONS
